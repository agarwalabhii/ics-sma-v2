...
class Credential {
  ...
  Future<UserInfo> getUserInfo() async {
    ...
    var decodedJwtResponse = JsonWebToken.unverified(response);
    return UserInfo.fromJson(decodedJwtResponse.claims.toJson());
  }
...
class Flow {
  ...
  Flow._(this.type, this.responseType, this.client,
      ...
      : state = state ?? _randomString(20),
        ...
        redirectUri = redirectUri ?? Uri.parse('https://local.sma.auth') {
